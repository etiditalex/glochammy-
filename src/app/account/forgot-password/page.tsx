...
import { isSupabaseConfigured } from "@/lib/products/catalog";
          ...
          {configured ? (
            ...
            <>
              <p className="font-sans text-sm leading-[1.7] text-ink sm:text-base">
                Password reset by email will be available once Supabase
                environment variables are added to this project. Until then,
                contact us and we can help you recover access.
              </p>
