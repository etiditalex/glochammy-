...
export function Hero() {
  return (
    <>
      <section
        className="relative isolate w-full overflow-hidden bg-ink md:min-h-[88vh] md:supports-[min-height:1dvh]:min-h-[88dvh]"
        aria-label="Hero"
      >
        <HeroMobile />

        <div className="relative hidden min-h-[88vh] overflow-hidden md:block md:supports-[min-height:1dvh]:min-h-[88dvh]">
